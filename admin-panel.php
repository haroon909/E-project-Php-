      ...
      <ul class="navbar-nav mr-auto">
        <form action="logoutfunc.php" method="post">
          <li class="nav-item">
            ...
            <button type="submit" name="adlogout"> <i class="fa fa-sign-out" aria-hidden="true">Logout</i></button></a>
          </li>
        </form>
        <li class="nav-item">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  echo "<td><a href='update_form.php?demail=" . $row['email'] . "'>Update</a></td>";
                  echo "</tr>";
                }
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  echo "<td>" . $row['password'] . "</td>";
                  echo "<td>";
                  echo "<a  href='update_patient_form.php?pid=" . $row['pid'] . "'>Update</a></td>";
                  echo "<td>";
                  echo "<a href='javascript:deletePatient(" . $row['pid'] . ")'>Delete</a></td>";
                  echo "</tr>";
                }
