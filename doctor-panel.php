...
if (isset($_GET['delete_patient'])) {
  ...
  if ($result) {
    ...
    echo "<script>alert('Error deleting patient record. Please try again!');</script>";
  }
}
      ...
      <ul class="navbar-nav mr-auto">
        <form action="logoutfunc.php" method="post">
          <li class="nav-item">
            ...
            <button type="submit" name="drlogout"> <i class="fa fa-sign-out" aria-hidden="true">Logout</i></button></a>
          </li>
        </form>
        <li class="nav-item">
        <a class="nav-link"></a>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if (($row['userStatus'] == 1) && ($row['doctorStatus'] == 1)) { ?>
                          <a href="doctor-panel.php?ID=<?php echo $row['ID']; ?>&cancel=update" onClick="return confirm('Are you sure you want to cancel this appointment?')" title="Cancel Appointment" tooltip-placement="top" tooltip="Remove">
