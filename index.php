    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="admin-login.php" style="color: white;font-family: 'IBM Plex Sans', sans-serif;">
              <h6>ADMIN-LOGIN</h6>
            </a>
          </li>
        </ul>
  ...
  <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#34495E;">
    ...
    animation: mover 1s infinite alternate;">
        ...
        <div style="color: white;">
          <h4 style="font-family: 'IBM Plex Sans', sans-serif;"> We are here for you! Always there for you</h4>
        </div>

      </div>

      <div class="col-md-4" style="margin-top: 5%;right: 8%">
        <div class="card bg-dark text-light" style="font-family: 'IBM Plex Sans', sans-serif;">
          <div class="card-body ">
            <center>
              <i class="fa fa-hospital-o fa-3x" aria-hidden="true" style="color:#0062cc"></i>
              <br>
              <h3 style="margin-top: 10%">Login</h3><br>
              <form class="form-group" method="POST" action="loginfunc.php">
                <div class="row" style="margin-top: 10%">
                  ...
                  <div class="col-md-8" style="margin-top: 8%"><input type="password" class="form-control" name="password" placeholder="Password" required /></div><br><br><br>
                </div>
                <div class="row">
                  <div class="" style="padding-left: 160px;margin-top: 10%">
                    <input type="submit" id="inputbtn" name="palogin" class="btn btn-primary">
                  </div>
              ...
              <div><p>Don't Have an account? <a href="register.php">SignUP!!</a></p></div>
            </center>
          </div>
        </div>
      </div>
