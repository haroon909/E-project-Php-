...
<body>
    ...
    <div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
        <div class="row">
            ...
            <div class="col-md-9 register-right bg-dark text-light" style="margin-top: 40px;left: 80px;">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <h3 class="register-heading text-light">Register</h3>
                        <form method="post" action="func2.php">
                            <div class="row register-form">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="tel" minlength="10" maxlength="13" name="contact" class="form-control" placeholder="Phone.No: +92"  />
                                    </div>
                                    <div class="form-group">
